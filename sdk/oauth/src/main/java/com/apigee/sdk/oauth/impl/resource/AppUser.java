 ...
 */
public class AppUser extends AbstractResource implements com.apigee.sdk.oauth.api.resource.AppUser {
    ...
    protected RestCallResult onCreate() {
        ...
        return getRestAPIClient().invoke(request);
    }
    ...
    @Override
    public com.apigee.sdk.oauth.api.resource.AppUser forApp(String appName) {
        return com.apigee.sdk.oauth.api.resource.AppUser.class.cast(super.forApp(appName));
    }
    ...
    @Override
    public com.apigee.sdk.oauth.api.resource.AppUser create() throws ResourceException {
        return com.apigee.sdk.oauth.api.resource.AppUser.class.cast(super.create());
    }
