...
public abstract class AbstractResource implements Resource {
    ...
    @Override
    public <T extends Resource> T forApp(String appName) {
     ...
     */
    @Override
    public <T extends Resource> T belongingTo(AppOwner owner) {
     ...
     */
    @Override
    public  <T extends Resource> T create() throws ResourceException {
