 ...
 *
 * @param T - the Resource type parameter which is the required type to be returned for correct chaining to work.
 */
public interface Resource<T extends  Resource<T>>  {
     ...
     */
     T create() throws ResourceException;
